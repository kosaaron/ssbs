...
if($no_of_row == 1){
    ...
    $query = "UPDATE employees SET UserPassword = :Password, VerificationStatus=1, ActivationCode=NULL 
    ...
    echo 'test';
    $query = "INSERT INTO device_verification 
    (DeviceId, EmployeeFK) 
    ...
    $query = "SELECT * FROM device_verification
    ...
    echo 'Valami',
         'valami2';
    echo 'localStorage.setItem("id_dev", "' . $id_dev . '");',
         'localStorage.setItem("devicecode", "' . $device_hash . '");',
         'localStorage.setItem("userId", "' . $userId . '");',
         'localStorage.setItem("firstname", "' . $userFName . '");',
         'localStorage.setItem("email", "' . $userEmail . '");';

...
export default class StepBox {
    ...
    constructor(plugin, frameId, parentFrameId) {
        StepBox.create(plugin, frameId, parentFrameId);
        this.events(plugin, frameId, parentFrameId);
        StepBox.callChilds(plugin, frameId);
    ...
    events(plugin, frameId, parentFrameId) {
        $(`#${parentFrameId}`).bind(`${parentFrameId}_change_details`, function (e) {
            ...
            StepBox.refresh(plugin, frameId, parentFrameId, objectId);
        });
        ...
        $(`#${frameId}`).bind(`${frameId}_child_loaded`, function (e) {
            ...
            StepBox.createChildFrame(targetId, frameId, childPluginId);

            let changeData = {};
            changeData.Plugin = StepBox.getCurrentPlugin(plugins, pluginNumber);
    ...
    static refresh(plugin, frameId, parentFrameId, objectId) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                StepBox.create(newPlugin, frameId, parentFrameId);
